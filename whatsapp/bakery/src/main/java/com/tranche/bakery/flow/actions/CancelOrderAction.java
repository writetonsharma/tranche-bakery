...
@Slf4j
public class CancelOrderAction implements FlowAction {

    private final OrderService orderService;
    private final OrderRepository orderRepository;

    @Override
    public String getName() { return "CANCEL_ORDER"; }
    ...
    public void execute(ActionContext ctx) {
        ...
        log.info("Order {} cancelled for customer {}", order.getId(), ctx.getCustomer().getPhone());
    }
}
